//ma3apcminimk2color wing3 v1.0.5 by ArtGateOne
...
udpPort.on("message", function (oscMsg, timeTag, info) {
  ...
  */
  else if (oscMsg.address == "/Key231") { light_executor(0, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key232") { light_executor(1, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key233") { light_executor(2, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key234") { light_executor(3, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key235") { light_executor(4, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key236") { light_executor(5, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key237") { light_executor(6, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key238") { light_executor(7, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key101") { light_executor(16, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key102") { light_executor(17, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key103") { light_executor(18, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key104") { light_executor(19, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key105") { light_executor(20, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key106") { light_executor(21, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key107") { light_executor(22, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key108") { light_executor(23, oscMsg.args[0].value, oscMsg.args[1].value); }
...
input.on('noteon', function (msg) {//recive midi keys and send to osc
  ...
  if (msg.note >= 0 && msg.note <= 7) {
    udpPort.send({ address: "/Key" + (msg.note + 231), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 8 && msg.note <= 15) {
    //do nothing
  }
  else if (msg.note >= 16 && msg.note <= 23) {
    udpPort.send({ address: "/Key" + (msg.note + 85), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
...
input.on('noteoff', function (msg) {//recive midi keys and send to osc
  ...
  if (msg.note >= 0 && msg.note <= 7) {
    udpPort.send({ address: "/Key" + (msg.note + 231), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 8 && msg.note <= 15) {
    //do nothing
  }
  else if (msg.note >= 16 && msg.note <= 23) {
    udpPort.send({ address: "/Key" + (msg.note + 85), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 24 && msg.note <= 31) {
