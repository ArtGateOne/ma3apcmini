//ma3 wing3 v1.0.5 by ArtGateOne
...
udpPort.on("message", function (oscMsg, timeTag, info) {
  ...
  */
  else if (oscMsg.address == "/Key131") { light_executor(0, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key132") { light_executor(1, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key133") { light_executor(2, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key134") { light_executor(3, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key135") { light_executor(4, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key136") { light_executor(5, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key137") { light_executor(6, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key138") { light_executor(7, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key231") { light_executor(16, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key232") { light_executor(17, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key233") { light_executor(18, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key234") { light_executor(19, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key235") { light_executor(20, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key236") { light_executor(21, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key237") { light_executor(22, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key238") { light_executor(23, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key331") { light_executor(32, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key332") { light_executor(33, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key333") { light_executor(34, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key334") { light_executor(35, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key335") { light_executor(36, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key336") { light_executor(37, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key337") { light_executor(38, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key338") { light_executor(39, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key431") { light_executor(48, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key432") { light_executor(49, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key433") { light_executor(50, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key434") { light_executor(51, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key435") { light_executor(52, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key436") { light_executor(53, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key437") { light_executor(54, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key438") { light_executor(55, oscMsg.args[0].value, oscMsg.args[1].value); }
...
input.on('cc', function (msg) {//Fader send OSC
  ...
  if (msg.controller >= 48 && msg.controller <= 55) {
    var OSCaddress = "/Fader23" + (msg.controller - 47);
...
input.on('noteon', function (msg) {//recive midi keys and send to osc
  ...
  if (msg.note >= 0 && msg.note <= 7) {
    udpPort.send({ address: "/Key" + (msg.note + 131), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 8 && msg.note <= 15) {
    //do nothing
  }
  else if (msg.note >= 16 && msg.note <= 23) {
    udpPort.send({ address: "/Key" + (msg.note + 215), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 24 && msg.note <= 31) {
    //do nothing
  }
  else if (msg.note >= 32 && msg.note <= 39) {
    udpPort.send({ address: "/Key" + (msg.note + 299), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 40 && msg.note <= 47) {
    //do nothing
  }
  else if (msg.note >= 48 && msg.note <= 55) {
    udpPort.send({ address: "/Key" + (msg.note + 383), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 56 && msg.note <= 63) {
    //do nothing
  }
  else if (msg.note >= 100 && msg.note <= 107) {
    udpPort.send({ address: "/Fader" + (msg.note + 131), args: [{ type: "i", value: 127 }] }, remoteip, remoteport);
...
input.on('noteoff', function (msg) {//recive midi keys and send to osc
  ...
  if (msg.note >= 0 && msg.note <= 7) {
    udpPort.send({ address: "/Key" + (msg.note + 131), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 8 && msg.note <= 15) {
    //do nothing
  }
  else if (msg.note >= 16 && msg.note <= 23) {
    udpPort.send({ address: "/Key" + (msg.note + 215), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 24 && msg.note <= 31) {
    //do nothing
  }
  else if (msg.note >= 32 && msg.note <= 39) {
    udpPort.send({ address: "/Key" + (msg.note + 299), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 40 && msg.note <= 47) {
    //do nothing
  }
  else if (msg.note >= 48 && msg.note <= 55) {
    udpPort.send({ address: "/Key" + (msg.note + 383), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 56 && msg.note <= 63) {
    //do nothing
  }
  else if (msg.note >= 100 && msg.note <= 107) {
    udpPort.send({ address: "/Fader" + (msg.note + 131), args: [{ type: "i", value: Fader[msg.note - 100] }] }, remoteip, remoteport);
    output.send('noteon', { note: msg.note, velocity: msg.velocity, channel: 0 });
  }
  else if (msg.note == 122) {//BO
    BO = 0;
