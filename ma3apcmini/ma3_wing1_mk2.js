//ma3 wing1 v1.0.5 by ArtGateOne
...
udpPort.on("message", function (oscMsg, timeTag, info) {
  ...
  */
  ...
  else if (oscMsg.address == "/Key201") { light_executor(16, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key202") { light_executor(17, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key203") { light_executor(18, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key204") { light_executor(19, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key205") { light_executor(20, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key206") { light_executor(21, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key207") { light_executor(22, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key208") { light_executor(23, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key301") { light_executor(32, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key302") { light_executor(33, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key303") { light_executor(34, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key304") { light_executor(35, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key305") { light_executor(36, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key306") { light_executor(37, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key307") { light_executor(38, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key308") { light_executor(39, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key401") { light_executor(48, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key402") { light_executor(49, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key403") { light_executor(50, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key404") { light_executor(51, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key405") { light_executor(52, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key406") { light_executor(53, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key407") { light_executor(54, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key408") { light_executor(55, oscMsg.args[0].value, oscMsg.args[1].value); }
});
...
input.on('noteon', function (msg) {//recive midi keys and send to osc
  ...
  if (msg.note >= 0 && msg.note <= 7) {
    ...
    udpPort.send({ address: "/Key" + (msg.note + 185), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 24 && msg.note <= 31) {
    //do nothing
  }
  else if (msg.note >= 32 && msg.note <= 39) {
    udpPort.send({ address: "/Key" + (msg.note + 269), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 40 && msg.note <= 47) {
    //do nothing
  }
  else if (msg.note >= 48 && msg.note <= 55) {
    udpPort.send({ address: "/Key" + (msg.note + 353), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
...
input.on('noteoff', function (msg) {//recive midi keys and send to osc
  ...
  if (msg.note >= 0 && msg.note <= 7) {
    ...
    udpPort.send({ address: "/Key" + (msg.note + 185), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 24 && msg.note <= 31) {
    //do nothing
  }
  else if (msg.note >= 32 && msg.note <= 39) {
    udpPort.send({ address: "/Key" + (msg.note + 269), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 40 && msg.note <= 47) {
    //do nothing
  }
  else if (msg.note >= 48 && msg.note <= 55) {
    udpPort.send({ address: "/Key" + (msg.note + 353), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 56 && msg.note <= 63) {
    //do nothing
  }
