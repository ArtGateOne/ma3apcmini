//ma3 wing2 v1.0.5 by ArtGateOne
...
udpPort.on("message", function (oscMsg, timeTag, info) {
  ...
  */
  else if (oscMsg.address == "/Key116") { light_executor(0, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key117") { light_executor(1, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key118") { light_executor(2, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key119") { light_executor(3, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key120") { light_executor(4, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key121") { light_executor(5, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key122") { light_executor(6, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key123") { light_executor(7, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key216") { light_executor(16, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key217") { light_executor(17, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key218") { light_executor(18, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key219") { light_executor(19, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key220") { light_executor(20, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key221") { light_executor(21, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key222") { light_executor(22, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key223") { light_executor(23, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key316") { light_executor(32, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key317") { light_executor(33, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key318") { light_executor(34, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key319") { light_executor(35, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key320") { light_executor(36, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key321") { light_executor(37, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key322") { light_executor(38, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key323") { light_executor(39, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key416") { light_executor(48, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key417") { light_executor(49, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key418") { light_executor(50, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key419") { light_executor(51, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key420") { light_executor(52, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key421") { light_executor(53, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key422") { light_executor(54, oscMsg.args[0].value, oscMsg.args[1].value); }
  else if (oscMsg.address == "/Key423") { light_executor(55, oscMsg.args[0].value, oscMsg.args[1].value); }
});
...
input.on('cc', function (msg) {//Fader send OSC
  ...
  if (msg.controller >= 48 && msg.controller <= 55) {
    var OSCaddress = "/Fader2" + (msg.controller - 32);
...
input.on('noteon', function (msg) {//recive midi keys and send to osc
  ...
  if (msg.note >= 0 && msg.note <= 7) {
    udpPort.send({ address: "/Key" + (msg.note + 116), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 8 && msg.note <= 15) {
    //do nothing
  }
  else if (msg.note >= 16 && msg.note <= 23) {
    udpPort.send({ address: "/Key" + (msg.note + 200), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 24 && msg.note <= 31) {
    //do nothing
  }
  else if (msg.note >= 32 && msg.note <= 39) {
    udpPort.send({ address: "/Key" + (msg.note + 284), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 40 && msg.note <= 47) {
    //do nothing
  }
  else if (msg.note >= 48 && msg.note <= 55) {
    udpPort.send({ address: "/Key" + (msg.note + 368), args: [{ type: "i", value: 1 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 56 && msg.note <= 63) {
    //do nothing
  }
  else if (msg.note >= 100 && msg.note <= 107) {
    udpPort.send({ address: "/Fader" + (msg.note + 116), args: [{ type: "i", value: 127 }] }, remoteip, remoteport);
...
input.on('noteoff', function (msg) {//recive midi keys and send to osc
  ...
  if (msg.note >= 0 && msg.note <= 7) {
    udpPort.send({ address: "/Key" + (msg.note + 116), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 8 && msg.note <= 15) {
    //do nothing
  }
  else if (msg.note >= 16 && msg.note <= 23) {
    udpPort.send({ address: "/Key" + (msg.note + 200), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 24 && msg.note <= 31) {
    //do nothing
  }
  else if (msg.note >= 32 && msg.note <= 39) {
    udpPort.send({ address: "/Key" + (msg.note + 284), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 40 && msg.note <= 47) {
    //do nothing
  }
  else if (msg.note >= 48 && msg.note <= 55) {
    udpPort.send({ address: "/Key" + (msg.note + 368), args: [{ type: "i", value: 0 }] }, remoteip, remoteport);
  }
  else if (msg.note >= 56 && msg.note <= 63) {
    //do nothing
  }
  else if (msg.note >= 100 && msg.note <= 107) {
    udpPort.send({ address: "/Fader" + (msg.note + 116), args: [{ type: "i", value: Fader[msg.note - 100] }] }, remoteip, remoteport);
    output.send('noteon', { note: msg.note, velocity: msg.velocity, channel: 0 });
  }
  else if (msg.note == 122) {//BO
    BO = 0;
